	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				<h1>
					部门管理 <small>可添加职位列表</small>
				</h1>
				<ol class="breadcrumb">
					<li><a href="${pageContext.request.contextPath}/notice/main.do"><i
							class="fa fa-dashboard"></i> 首页</a></li>
					<li><a
							href="${pageContext.request.contextPath}/department/findAll.do">部门管理</a></li>
					<li class="active">可添加职位列表</li>
				</ol>
			</section>
			<!-- 内容头部 /-->

			<form action="${pageContext.request.contextPath}/department/addOtherPosition.do" method="post">
				<!-- 正文区域 -->
