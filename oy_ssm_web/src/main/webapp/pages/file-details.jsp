                        ...
                        <table id="dataList" class="table table-bordered table-striped table-hover dataTable">
                            ...
                            <tr>
                                ...
                                <td class="col-lg-1 text-center">
                                    ...
                                    <input type="radio" name="gender" value="男" ${userFile.gender=='男'?'checked':''}>男
                                    <input type="radio" name="gender" value="女" ${userFile.gender=='女'?'checked':''}>女
                                </div></td>
                                <th class="col-lg-1 text-center">民族</th>
                                <td class="col-lg-1 text-center">
                                    <input name="people" type="text" value="${userFile.people}"> </td>
                            </tr>
                            <tr>
                                <th class="col-lg-1 text-center">出生日期</th>
                                <td> <input type="text" name="birthday" value="${userFile.birthdayStr}"></td>
                                <th class="col-lg-1 text-center">身份证号</th>
                                <td colspan="3"> <input type="text" name="id" value="${userFile.id}" > </td>
                            </tr>
                            <tr>
                                <th class="col-lg-1 text-center">政治面貌</th>
                                <td>
                                    <input name="politics" type="radio" value="中共党员" ${userFile.politics=='中共党员'?'checked':''}>中共党员
                                    <input name="politics" type="radio" value="共青团员" ${userFile.politics=='共青团员'?'checked':''}>共青团员
                                    <input name="politics" type="radio" value="群众" ${userFile.politics=='群众'?'checked':''}>群众
                                    <input name="politics" type="radio" value="其他" ${userFile.politics=='其他'?'checked':''}>其他</td>
                                <th class="col-lg-1 text-center">婚姻状况</th>
                                <td>
                                    <input name="marital_status" type="radio" value="已婚" ${userFile.marital_status=='已婚'?'checked':''}>已婚
                                    <input name="marital_status" type="radio" value="未婚"  ${userFile.marital_status=='未婚'?'checked':''}>未婚</td>
                                <th class="col-lg-1 text-center">学历</th>
                                <td><input name="education" type="text" value="${userFile.education}">  </td>
                            </tr>
                            <tr>
                                <th class="col-lg-1 text-center">毕业学校</th>
                                <td colspan="2"><input name="school" type="text" style="width: 350px" value="${userFile.school}">  </td>
                                <th class="col-lg-1 text-center">专业</th>
                                <td colspan="2"> <input name="specialty" type="text" style="width: 350px" value="${userFile.specialty}"></td>
                            </tr>
                            <tr>
                                <th class="col-lg-1 text-center">户口所在地</th>
                                <td><input name="hk_adr" type="text" value="${userFile.hk_adr} "></td>
                                <th class="col-lg-1 text-center">籍贯</th>
                                <td>  <input name="census_register" type="text" value="${userFile.census_register}"></td>
                                <th class="col-lg-1 text-center">户口性质</th>
                                <td>
                                    <input name="hk_type" type="radio" value="城镇户口" ${userFile.hk_type=='城镇户口'?'checked':''}>城镇户口
                                    <input name="hk_type" type="radio" value="农村户口" ${userFile.hk_type=='农村户口'?'checked':''}>农村户口
                                </td>
                            </tr>
                            <tr>
                                <th class="col-lg-1 text-center">家庭住址</th>
                                <td colspan="3"><input name="address" type="text" style="width: 650px" value="${userFile.address}"> </td>
                                <th class="col-lg-1 text-center">邮政编码</th>
                                <td><input name="postcode" type="text" value="${userFile.postcode}"> </td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td colspan="2">
                                    <div class="form-group">
                                        <input name="source" type="radio" value="网络招聘" ${userFile.source=='网络招聘'?'checked':''}>网络招聘
                                        <input name="source" type="radio" value="内部推荐" ${userFile.source=='内部推荐'?'checked':''}>内部推荐
                                    </div>
                                </td>
                                <th></th>
                                <td colspan="2"> </td>
